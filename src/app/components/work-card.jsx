...
const WorkCard = ({
  ...
  return (
    <div className="w-full xs:h-32 md:h-[164px] xs:p-3 md:p-4 bg-card-bg border rounded-2xl border-card-border flex gap-4">
      ...
      <div className="flex flex-col justify-center h-full">
        ...
        <p className="xs:text-body-2-mb md:text-body-2 text-dark-gray">{desc}</p>
      </div>
    </div>
  );
};
